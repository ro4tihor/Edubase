...
<html lang="en">
  ...
  include("nav2.php");
	   ...
	   <div class="lead text-center"> <center>Edit Profile Details</center></div>
		<form action="student_replace.php" enctype="multipart/form-data" method="post">
		...
		<label>Selects</label>
		 ...
		 <label>Roll No. </label>
		<input type="text"  class="form-control" value="<?php echo $rollno;?>"placeholder="Enter Your roll number" name="rollno" pattern="[0-9]{4}" required autofocus data-validation-required-message="Please enter only numbers">
