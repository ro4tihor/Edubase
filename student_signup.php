...
<html lang="en">
  ...
  <body >
		...
		<div class="lead text-center"> <center>Student Registration</center></div>
		<form action="student_insert.php" onsubmit="return validate()"  enctype="multipart/form-data" method="post">
		...
		<label>Selects</label>
		 ...
		 <label>Roll No. </label>
		<input type="text"  class="form-control" placeholder="Enter Your roll number" name="rollno" pattern="[0-9]{4}" required autofocus data-validation-required-message="Please enter only numbers">
