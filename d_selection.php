...
header("location:d_thread.php");
if(isset($_POST['submit']))
{
	$_SESSION['temp1']=$_POST['submit'];
...
<html lang="en">
  <head>
	...
	?>
		...
		<div class="col-lg-4"><h4> Start Discussion</h4></div>
		</div>
		<?php
		$i=1;
		...
		<form action="<?=$_SERVER["PHP_SELF"]; ?>" method="post"><div class="col-lg-4"><button type=submit name="submit" value="<?php echo $value['teacher']['username'];?>"class="btn btn-primary">Select Teacher</button></div></form>
